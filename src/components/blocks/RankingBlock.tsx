                ...
                `}>
                    {items.map((item, index) => (
                        <motion.div
                            ...
                            className={`
                                p-6 bg-white/80 rounded-2xl shadow-lg backdrop-blur-sm hover:scale-[1.02] transition-transform duration-300
                                ${layout === 'grid' ? 'flex flex-col items-center text-center' : 'flex items-center'}
                                ${layout === 'split' ? 'break-inside-avoid mb-4' : ''}
                            `}
                        >
                            <div className={`
                                flex items-center justify-center rounded-full font-black text-2xl shadow-inner flex-shrink-0
                                ${layout === 'grid' ? 'w-12 h-12 mb-4' : 'w-14 h-14 mr-6'}
                            ...
                            {item.image?.asset && (
                                <div className={`
                                    ...
                                    ${layout === 'grid' ? 'w-20 h-20 mb-4' : 'w-16 h-16 mr-6'}
                                `}>
                                    <Image
